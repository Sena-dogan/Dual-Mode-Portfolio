            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group relative rounded-2xl overflow-hidden bg-[#1E293B] border border-slate-700 hover:border-indigo-500/50 transition-all duration-300 flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="flex gap-4 mt-auto">
                        <a href="https://jobinspector.devopen.io" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-slate-800 rounded-lg text-sm text-white hover:bg-slate-700 border border-slate-600 transition-colors w-full justify-center">
                          <ArrowRight size={16} /> View Demo
                        </a>
                      </div>
                  </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {labProjects.map((project) => (
              <div key={project.id} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:border-purple-100 transition-all duration-300">
                ...
                <a href="#" className="inline-flex items-center text-sm font-semibold text-purple-600 hover:text-purple-800">
